    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommandePizzas", x => new { x.CommandeId, x.PizzaId });
                    table.ForeignKey(
                        name: "FK_CommandePizzas_Commandes_CommandeId",
                        column: x => x.CommandeId,
                        principalTable: "Commandes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommandePizzas_Pizzas_PizzaId",
                        column: x => x.PizzaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommandePizzas_PizzaId",
                table: "CommandePizzas",
                column: "PizzaId");
        }
